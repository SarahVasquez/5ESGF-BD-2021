...
namespace SudokuCombinatorialEvolutionSolver
{
    public class SudokuSolver
    {
        ...
        public Sudoku Solve(int[,] sudoku, int numOrganisms, int maxEpochs, int maxRestarts)
        {
        ...
        private Sudoku SolveInternal(int[,] sudoku, int numOrganisms, int maxEpochs)
        {
            ...
            for (var i = 0; i < numOrganisms; ++i)
            {
                ...
                var randomSudoku = Sudoku.New(MatrixHelper.RandomMatrix(_rnd, sudoku));
            ...
            while (epoch < maxEpochs)
            {
                ...
                for (var i = 0; i < numOrganisms; ++i)
                {
                    ...
                    {
                        var neighbor = MatrixHelper.NeighborMatrix(_rnd, sudoku, hive[i].Matrix);
